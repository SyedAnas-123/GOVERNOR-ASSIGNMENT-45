var guestList = ["Albert Einstein", "Marie Curie", "Leonardo da Vinci", "Isaac Newton", "Galileo Galilei", "Nikola Tesla", "Ada Lovelace"];
...
while (guestList.length > 2) {
    var removedGuest = guestList.pop(); // Remove last guest
